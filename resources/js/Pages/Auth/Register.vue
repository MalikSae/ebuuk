          ...
          <div v-if="currentStep === 1">
            ...
            <div class="flex gap-3 mt-6">
              <button @click="prevStep"
                      class="w-14 sm:w-auto sm:flex-1 flex items-center justify-center gap-2 py-3 border border-slate-200 text-slate-600
              ...
              <div>
                ...
                <div class="relative">
                  <input v-model="form.password" :type="showPassword ? 'text' : 'password'" required
                         ...
                         class="w-full border border-slate-200 rounded-lg pl-4 pr-10 py-2.5
                                text-sm focus:outline-none focus:ring-2 focus:ring-teal-500
                                focus:border-transparent">
