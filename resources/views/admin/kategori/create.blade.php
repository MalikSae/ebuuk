...
<div class="mb-5 text-sm text-slate-400">
    <a href="{{ route('admin.kategori.index') }}" class="text-teal-600 hover:text-teal-700">Kategori</a> › Tambah
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 max-w-lg">
    <form action="{{ route('admin.kategori.store') }}" method="POST">
        ...
        <div class="mt-4">
            ...
            <input type="hidden" name="icon" id="icon-value" value="{{ old('icon', 'book-open') }}">
        </div>
